...
export default function Contact() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: "89cbdd31-d65c-4596-8322-8e678f1aedfd",
          name: formData.name,
  ...
  return (
    <section id="contact" className="py-12 md:py-20 bg-gradient-to-br from-sky-50 via-white to-slate-100 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-indigo-100/60 rounded-full filter blur-3xl opacity-60" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-100/60 rounded-full filter blur-3xl opacity-60" />
          ...
          >
            ...
            <div className="space-y-4 md:space-y-6">
              <motion.div
                ...
                className="flex items-start bg-white/85 border border-indigo-100 p-3 md:p-4 rounded-xl shadow-lg backdrop-blur"
              >
                <svg className="w-5 h-5 md:w-6 md:h-6 flex-shrink-0 text-indigo-600 mt-1 mr-3 md:mr-4" width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <div>
                  <p className="font-medium text-slate-900">Email</p>
                  <a href="mailto:rahulchandradey08@gmail.com" className="text-indigo-600 hover:text-indigo-500">
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:+8801615747455" className="text-slate-600 hover:text-indigo-600">
                    +880 1615-747455
                  </a>
                </div>
              </motion.div>
              ...
              <div className="flex gap-3 md:gap-4">
                <motion.a
                  ...
                  className="p-3 bg-white/85 border border-indigo-100 rounded-full hover:border-indigo-300 transition-all shadow-lg backdrop-blur text-slate-600 hover:text-indigo-600"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                className="w-full px-4 py-3 bg-white border border-indigo-100 rounded-lg text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-indigo-400 focus:border-indigo-300 transition-colors"
                />
              </div>
              ...
              <motion.button
                ...
                className="w-full px-6 py-3 bg-gradient-to-r from-sky-400 to-slate-200 text-slate-900 rounded-lg hover:from-sky-500 hover:to-slate-300 transition-all font-medium shadow-lg hover:shadow-xl disabled:from-slate-200 disabled:to-slate-200 disabled:text-slate-400 disabled:cursor-not-allowed"
              >
              ...
              {status === "success" && (
                <motion.div
                  ...
                  className="p-4 bg-indigo-50 text-indigo-700 border border-indigo-200 rounded-lg"
                >
                  {statusMessage}
                </motion.div>
              )}
              ...
              {status === "error" && (
                <motion.div
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="p-4 bg-rose-50 text-rose-600 border border-rose-200 rounded-lg"
                >
                  {statusMessage}
                </motion.div>
              )}
