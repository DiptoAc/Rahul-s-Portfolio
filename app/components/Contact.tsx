...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-sky-50 via-white to-slate-100 relative overflow-hidden">
          ...
          >
            ...
            <div className="space-y-6">
              <motion.div
                ...
                className="flex items-start bg-white/85 border border-indigo-100 p-4 rounded-xl shadow-lg backdrop-blur"
              >
                <svg className="w-6 h-6 flex-shrink-0 text-indigo-600 mt-1 mr-4" width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
