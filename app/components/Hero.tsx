  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 pt-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute bottom-20 left-40 w-72 h-72 bg-indigo-500 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-300 mb-6 font-semibold">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              href="#projects"
              className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg hover:shadow-blue-500/50 transform hover:scale-105"
            >
              View Projects
            </a>
            <a
              href="#contact"
              className="px-8 py-3 bg-gray-800/50 backdrop-blur-sm text-blue-300 rounded-full hover:bg-gray-700/50 transition-all shadow-lg border border-blue-400/30 hover:border-blue-400/60 transform hover:scale-105"
            >
              Get in Touch
            </a>
          </div>
