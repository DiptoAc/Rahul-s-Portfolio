...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <motion.div 
        className="container mx-auto px-4 md:px-6 py-12 md:py-20 relative z-10"
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <div className="relative p-1 rounded-full bg-gradient-to-r from-sky-300 to-blue-200">
              <motion.img 
                ...
                className="relative w-56 h-56 sm:w-64 sm:h-64 md:w-80 md:h-80 rounded-full object-cover shadow-2xl border-4 border-white animate-float"
              />
            </div>
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="/certificates"
              className="px-6 py-3 md:px-8 md:py-4 glass-dark text-indigo-900 rounded-full shadow-xl border border-indigo-300/60 hover:border-indigo-400/80 transition-all font-semibold backdrop-blur-md"
            >
              Certificates
            </motion.a>
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-3 md:px-8 md:py-4 glass-dark text-slate-700 rounded-full shadow-xl border border-slate-300/70 hover:border-indigo-400/70 transition-all font-semibold backdrop-blur-md"
            >
              Read My Stories
            </motion.a>
          </motion.div>
          ...
          <motion.div 
            ...
            className="flex gap-4 md:gap-6 mt-6 md:mt-8 flex-wrap justify-center"
          >
            <motion.a
              whileHover={{ 
                scale: 1.2, 
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              href="https://mail.google.com/mail/?view=cm&fs=1&to=rahulchandradey08@gmail.com&su=Portfolio%20Inquiry"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              <svg className="w-8 h-8 relative z-10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM0 8h5v16H0V8zm7 0h4.8v2.2h.07c.67-1.27 2.31-2.6 4.75-2.6 5.08 0 6.02 3.34 6.02 7.68V24h-5v-7.4c0-1.77-.03-4.05-2.47-4.05-2.47 0-2.85 1.93-2.85 3.92V24h-5V8z" />
              </svg>
            </motion.a>
          </motion.div>
        </div>
