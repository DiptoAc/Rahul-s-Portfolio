                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedProject.tech.map((tech, index) => (
                      <span
                        key={index}
                        className="px-4 py-2 rounded-full font-medium bg-indigo-50 text-indigo-700 border border-indigo-200"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div className="flex gap-4">
                  {selectedProject.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 px-6 py-3 bg-slate-100 text-slate-800 rounded-lg hover:bg-indigo-50 transition-colors text-center font-medium border border-indigo-200"
                    >
                      View on GitHub
                    </a>
                  )}
                  {selectedProject.live && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 px-6 py-3 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 transition-colors text-center font-medium"
                    >
                      View Live Demo
                    </a>
                  )}
